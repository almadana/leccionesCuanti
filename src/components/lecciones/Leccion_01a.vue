<template>
  <article class="lesson_01a">
    <LessonHeader title="Tabla de frecuencias univariada" />
    <section class="introduction">
      <h2>Introducción</h2>
      <p>
      La Encuesta Latinobarómetro en su edición de  2017 indaga sobre la percepción de las personas acerca del grado de satisfacción con la vida. Las opciones de respuesta incluyeron "Para nada satisfecho", "No muy satisfecho", "Bastante satisfecho", "Muy satisfecho". La siguiente tabla muestra los datos para Uruguay.
      </p>
      <p>
      En esta lección se muestra la tabla de frecuencias absolutas resultante para esta variable. Más abajo se muestra una tabla de porcentajes y un gráfico de barras. En base a esta información, intenta responder las preguntas que se muestran más abajo.
      </p>
      <p>
      Cuando termines, prueba la <a class="link" @click="$emit('load_lesson', Leccion_1b)">versión editable de esta lección.</a>
    ...
    <section class="lesson_body">
            ...
            <table id="statistics_summary">
              ...
              <tbody>
                <tr v-for="(group,index) in groups" :key="index">
                  ...
                  <td class="freq_abs">{{group.value}}</td>
      ...
      <section class="next_lesson">
        <a class="link" @click="$emit('load_lesson', Leccion_1b)">Siguiente >></a>
      </section>
    </section>
  </article>
</template>
